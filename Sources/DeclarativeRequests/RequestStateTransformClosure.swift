...
/// (a `@Sendable` function from ``RequestState`` to `Void`). The result builder composes
/// these closures in declaration order. You typically don't construct one directly —
