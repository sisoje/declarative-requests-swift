...
public extension MIMEType {
    ...
    static let formURLEncoded: MIMEType = Application.formURLEncoded
    static let octetStream: MIMEType = Application.octetStream
    static let pdf: MIMEType = Application.pdf
